...
#define oqpi_ensure(COND)               ((COND) ? true : oqpi::assert_and_return_false(__FILE__, __LINE__, #COND))
#define oqpi_ensuref(COND, MSG, ...)    ((COND) ? true : oqpi::assert_and_return_false(__FILE__, __LINE__, #COND, (MSG), ##__VA_ARGS__))
//--------------------------------------------------------------------------------------------------
...
#define oqpi_failed(COND)               ((COND) ? false : oqpi::assert_and_return_true(__FILE__, __LINE__, #COND))
#define oqpi_failedf(COND, MSG, ...)    ((COND) ? false : oqpi::assert_and_return_true(__FILE__, __LINE__, #COND, (MSG), ##__VA_ARGS__))
//--------------------------------------------------------------------------------------------------
